  		...
  		<ul>
  			...
  			<li class="bar">
  				<%
					...
					{%>
						<a href="#" onmouseover="touch('indexuser',404)" onmouseout="out('indexuser',404)"><img src="img/a.png">
  						<span id="indexuser">
					<%response.sendRedirect("../index.jsp?err=-2");
					}
					else
					{%>
						<a href="#" onmouseover="touch('indexuser',1)"><img src="img/a.png">
  						<span id="indexuser">
  			...
  			<li class="bar">
  				<a href="index.jsp" onmouseover="touch('indexhome',2)" onmouseout="out('indexhome',2)"><img src="img/b.png"><span id="indexhome"></span></a>
  			</li>
  			
  			<li><img src="img/baa.png"></li>
  			
  			<li class="bar">
  				<a href="#" onmouseover="touch('indexmsg',3)" onmouseout="out('indexmsg',3)"><img src="img/c.png"><span id="indexmsg"></span></a>
  			</li>
  			
  			<li><img src="img/baa.png"></li>
  			
  			<li class="bar">
  				<a href="#" onmouseover="touch('indexset',4)" onmouseout="out('indexset',4)"><img src="img/d.png"><span id="indexset"></span></a>
  			</li>
  			
  			<li><img src="img/baa.png"></li>
  			<li class="bar">
  				<a href="check/quit.jsp" onmouseover="touch('indexquit',5)" onmouseout="out('indexquit',5)"><img src="img/e.png"><span id="indexquit"></span></a>
  			</li>
  		</ul>
  	</div>
</div>
