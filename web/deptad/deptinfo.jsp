		    ...
		    <table width="1000" id="table" align="center" cellpadding="4" cellspacing="1" >
				...
				<c:forEach var="row" items="${result.rows}">
					<tr>
					   ...
					   <td>
					   		<a href="index.jsp?action=105-2&id=<c:out value="${row.deptid}"/>"/><img src="img/recordedit.gif" title="修改"/></a>
					   		&nbsp		<!-- ${row.staffid}返还赋予修改的ID-->
					   		<a href="index.jsp?action=105-3&id=<c:out value="${row.deptid}"/>"/><img src="img/recorddelete.gif" title="删除"/></a>
					   </td> 
					</tr>
				</c:forEach>
			</table>
